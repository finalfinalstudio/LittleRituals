...
function saveSettings() {
  localStorage.setItem('focusTimerSettingsV6', JSON.stringify({
...
function restoreSettings() {
  try {
    const settings = JSON.parse(localStorage.getItem('focusTimerSettingsV6') || localStorage.getItem('focusTimerSettingsV5') || '{}');
    ...
    if (settings.animation) el.animation.value = settings.animation;
...
el.animation.addEventListener('change', () => { applyAnimation(); saveSettings(); });
